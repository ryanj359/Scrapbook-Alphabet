...
function RandomFont() {
  var fonts = ["Arial", "Verdana", "Tahoma", "Trebuchet MS", "Times New Roman", "Georgia", "Garamond", "Courier New", "Brush Script MT", "serif", "sans-serif", "monospace", "cursive", "fantasy", "system-ui", "ui-serif", "ui-sans-serif", "ui-monospace", "ui-rounded"];
  var randomFont = fonts[Math.floor(Math.random() * fonts.length)];
  return randomFont;
}

function randomizeText() {
  const wordList = ["Anna", "Aydan", "Alex", "Andrew", "Buster", "Bart", "Claire", "Caitlyn", "Charlotte", "Charlie", "Chloe", "Duke", "Ethel", "Emily", "Enzo", "Elliot", "Elle", "Fara", "Georgia", "Griffin", "Gabe", "Genie", "Hannah", "Hippo", "Helena", "Isabelle", "Jackson", "John", "Jerome", "Jordan", "Julie", "Kiley", "Lauren", "Laurel", "Liam", "Leila", "Luke", "Maisel", "Mitt", "Max", "Malia", "Mercer", "Marshall", "Marcella", "Mike", "Natasha", "Noah", "Olivia", "Peter", "Patrick", "Penny", "Ryan", "Rinda", "Simon", "Seela", "Sean", "Stella", "Sawyer", "Saint", "Sophie", "Sushi", "Toad", "Victoria", "Vasco"];
...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("randomizeBtn").addEventListener("click", randomizeText);
});